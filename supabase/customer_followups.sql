...
drop function if exists public.submit_customer_review_with_token(text);
drop function if exists public.submit_customer_review_with_token(text, integer, text);
drop function if exists public.submit_customer_review_with_token(text, integer, text, text);
drop function if exists public.submit_customer_review_with_token(text, integer, text, text, boolean);
drop function if exists public.submit_customer_review_with_token(text, bigint, text, text, boolean);
drop function if exists public.submit_customer_review_with_token(text, numeric, text, text, boolean);
drop function if exists public.submit_customer_review_with_token(text, double precision, text, text, boolean);
drop function if exists public.submit_customer_review_with_token(text, text, text, text, boolean);
drop function if exists public.submit_customer_review_with_token(text, text, text, text, text);
