...
const TEXT = {
  de: {
    ...
    body: 'Wir verwenden notwendige lokale Einstellungen für Sprache und Datenschutz. Optionale Statistik hilft uns, Seitenaufrufe datensparsam in Supabase zusammenzufassen.',
    settings: 'Einstellungen',
    acceptAll: 'Alle akzeptieren',
    necessary: 'Nur notwendige',
    statsLabel: 'Statistik',
    statsHelp: 'Aggregierte Seiten-, Modell-, Sprach-, Geräte- und Herkunftszähler in Supabase.',
  ...
  en: {
    ...
    body: 'We use necessary local settings for language and privacy. Optional statistics help us aggregate page views sparingly in Supabase.',
    settings: 'Settings',
    acceptAll: 'Accept all',
    necessary: 'Necessary only',
    statsLabel: 'Statistics',
    statsHelp: 'Aggregated page, model, language, device and source counters in Supabase.',
    save: 'Save selection',
    back: 'Back',
  ...
  sk: {
    ...
    body: 'Používame nevyhnutné lokálne nastavenia pre jazyk a súkromie. Voliteľná štatistika nám pomáha úsporne agregovať zobrazenia stránok v Supabase.',
    settings: 'Nastavenia',
    acceptAll: 'Prijať všetko',
    necessary: 'Iba nevyhnutné',
    statsLabel: 'Štatistika',
    statsHelp: 'Agregované počítadlá stránok, modelov, jazyka, zariadenia a zdroja v Supabase.',
    save: 'Uložiť výber',
    back: 'Späť',
