...
const TEXT = {
  de: {
    ...
    body: 'Wir verwenden notwendige lokale Einstellungen für Sprache und Datenschutz. Optionale Einwilligungen steuern Vercel Analytics, Speed Insights und Google Maps.',
    settings: 'Einstellungen',
    acceptAll: 'Alle akzeptieren',
    necessary: 'Nur notwendige',
    statsLabel: 'Statistik',
    statsHelp: 'Vercel Web Analytics und Speed Insights für Seitenaufrufe und technische Performance-Messwerte.',
  ...
  en: {
    ...
    body: 'We use necessary local settings for language and privacy. Optional consent controls Vercel Analytics, Speed Insights and Google Maps.',
    settings: 'Settings',
    acceptAll: 'Accept all',
    necessary: 'Necessary only',
    statsLabel: 'Statistics',
    statsHelp: 'Vercel Web Analytics and Speed Insights for page-view and technical performance metrics.',
    mapsLabel: 'Google Maps',
  ...
  sk: {
    ...
    body: 'Používame nevyhnutné lokálne nastavenia pre jazyk a súkromie. Voliteľný súhlas riadi Vercel Analytics, Speed Insights a Google Maps.',
    settings: 'Nastavenia',
    acceptAll: 'Prijať všetko',
    necessary: 'Iba nevyhnutné',
    statsLabel: 'Štatistika',
    statsHelp: 'Vercel Web Analytics a Speed Insights na zobrazenia stránok a technické metriky výkonu.',
    mapsLabel: 'Google Maps',
